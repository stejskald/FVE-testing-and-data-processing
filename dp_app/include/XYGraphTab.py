...
class XYGraphTab(QWidget, Ui_XYGraphTab):
    def __init__(self, parent=None):
        ...
        self.lineDataRef = self.XYGraph.plot(self.time, self.voltage, pen=self.pen)
        self.adcChannelPlot = self.XYGraph.getPlotItem()
        self.adcChannelPlot.setLabel("left", "napětí", units="V")  # type: ignore
        self.adcChannelPlot.getAxis("left").label.setFont(QFont("Times", 12))  # type: ignore
